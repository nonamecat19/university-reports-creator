...
DEFINE FIELD IF NOT EXISTS user_name ON share TYPE string DEFAULT '';
...
DEFINE FIELD IF NOT EXISTS author_name ON comment TYPE string DEFAULT '';
...
DEFINE FIELD IF NOT EXISTS author_name ON suggestion_registry TYPE string DEFAULT '';
